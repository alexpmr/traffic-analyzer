...
def main() -> None:
    ...
    story += [P("Idioma", "TA_H2"),
              ...
              P("Responder usa o replyId nativo do Meshtastic/MeshMonitor para vincular a nova mensagem ao pacote original. O compositor também aceita emojis. Reações como like, dislike e coração são enviadas como tapbacks estruturados (emoji=1 + replyId) e aparecem agrupadas sob a mensagem original."),
